...
class HeaderPSBack extends StatelessWidget {
  const HeaderPSBack({super.key, this.onLogoTap, required this.onNavMenuTap});
    ...
    return Container(
            ...
            child: Row(
              children: [
                ...
                for (int i = 0; i < backNavPSTitles.length; i++)
                  Padding(
