...
class PSReportsTable extends StatefulWidget {
  const PSReportsTable({super.key});

  @override
  State<PSReportsTable> createState() => _PSReportsTableState();
}

class _PSReportsTableState extends State<PSReportsTable> {
  String _searchText = '';
